...
### Июль 2026
- Запущена закрытая бета.
- Добавлен ИИ-помощник.
- Улучшена аналитика результатов.
- Расширена база вопросов ЕНТ.
...
Оставьте Issue в этом репозитории. Все предложения рассматриваются во время разработки.
